...
const getErrorMessage = (error: unknown, fallback: string) => {
    if (error instanceof OrganizerApiRequestError)
    ...
    const fetchEvents = useCallback(async () => {
        ...
        try {
            ...
            toast.error(
                getErrorMessage(
                    error,
                    "Gagal mengambil daftar event organizer.",
                ),
            );
        } finally {
            setIsLoading(false);
                ...
                <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600">
                            Pilih event, buka scanner, dan pantau progress
                            kehadiran peserta.
                        </p>
                    </div>
                ...
                <>
                    ...
                    <div className="flex flex-col gap-3 rounded-2xl border border-slate-200/80 bg-white px-4 py-3 shadow-sm shadow-slate-900/5 sm:flex-row sm:items-center sm:justify-between">
                        <p className="text-sm font-medium text-slate-500">
                            ...
                            {totalEvents.toLocaleString("id-ID")} event
                        </p>
