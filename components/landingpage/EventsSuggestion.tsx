...
async function EventsSuggestionGrid() {
    ...
    try {
        ...
        events = await EventService.getRandomEvents(cookieHeader);
    } catch (error) {
    ...
    return (
        <section className="relative overflow-hidden py-16 md:py-24 bg-[#f9fafb]">
            ...
            >
                ...
                />
                <div className="absolute top-8 right-8 h-88 w-88 rounded-full bg-[#002cee14]" />
                <div className="absolute bottom-8 left-8 h-72 w-[18rem] rounded-full bg-[#6366f112]" />
            </div>
