          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            <div className="space-y-3">
              ...
              <p className="text-slate-400 text-sm md:text-base leading-relaxed max-w-sm">
                ...
                Platform manajemen event terpercaya di Indonesia.
              </p>
            </div>
            ...
            <div className="flex gap-2">
              <SocialButton
                ...
                icon={<InstagramIcon />}
              />
              <SocialButton href="https://x.com" icon={<XIcon />} />
              <SocialButton
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 items-start">
                ...
                <FooterLink href="/">Jadi Partner</FooterLink>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 items-start">
                ...
                <FooterLink href="/">Pedoman Komunitas</FooterLink>
              </div>
            </div>
...
function FooterLink({
  ...
  return (
    <Button
      asChild
      variant="link"
      className="p-0 h-auto text-slate-400 hover:text-white transition-colors justify-start font-normal"
    >
...
function SocialButton({ href, icon }: { href: string; icon: React.ReactNode }) {
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className="rounded-full bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition-all"
    >
