...
> = {
    ...
    hybrid: {
        ...
        icon: Laptop,
        colorClass:
            "bg-warning-light/60 text-warning-hover border-warning-light",
    },
};
...
function ReviewCard({ review }: ReviewCardProps) {
    ...
    return (
        <div className="flex gap-4 p-4 rounded-xl border border-border bg-card hover:border-primary/20 transition-colors duration-200">
            {/* Avatar */}
            <div className="shrink-0 w-9 h-9 rounded-full bg-linear-to-br from-primary/20 to-secondary/20 flex items-center justify-center">
        ...
        <div className="py-8 space-y-8 max-w-5xl mx-auto">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-border bg-card shadow-md">
                ...
                <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-6 p-7 sm:p-8">
                    ...
                    <div className="shrink-0 w-20 h-20 rounded-2xl bg-linear-to-br from-primary to-primary/60 flex items-center justify-center shadow-md shadow-primary/20">
